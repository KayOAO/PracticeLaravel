                ...
                <div class="card">
                    <div class="card-header pt-0">
                        ...
                        <small class="small text-muted">
                            <a href="#" class="text-muted">By : {{ $article->user->name }}</a>
                    ...
                    <div class="card-footer">
                        ...
                        <hr>
                        <div class="media">
                            <img src="{{ route('root') }}/assets/imgs/avatar-1.jpg" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
                                ...
                                <div class="media mt-5">
                                    <a class="mr-3" href="#">
                                    <img src="{{ route('root') }}/assets/imgs/avatar.jpg" class="thumb-sm rounded-circle" alt="...">
                                    </a>
                        ...
                        <div class="media mt-5">
                            <img src="{{ route('root') }}/assets/imgs/avatar-2.jpg" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
                        ...
                        <div class="media mt-4">
                            <img src="{{ route('root') }}/assets/imgs/avatar-3.jpg" class="mr-3 thumb-sm rounded-circle" alt="...">
                            <div class="media-body">
                ...
                <div class="row">
                        ...
                        <div class="card mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="{{ route('root') }}/assets/imgs/blog-2.jpg" alt="" class="w-100">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="{{ route('root') }}/assets/imgs/blog-3.jpg" alt="" class="w-100">
                    ...
                    <div class="col-md-6 col-lg-4 d-none d-lg-block">
                        <div class="card mb-5">
                            <div class="card-header p-0">
                                <div class="blog-media">
                                    <img src="{{ route('root') }}/assets/imgs/blog-4.jpg" alt="" class="w-100">
